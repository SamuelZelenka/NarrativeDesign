...
Shader "CloverSwatch/Xray"
{
	Properties
	{
		_MainTex("Texture", 2D) = "white" {}
		_Color("Color", Color) = (0,0,0,0)
		_InWorldTexture("Texture in world", 2D) = "white" {}
		_Opacity("Opacity", Range(0,1)) = 1

		_WorldColor("Color", Color) = (1,1,1,1)
		_WorldMainTex("Albedo (RGB)", 2D) = "white" {}
		...
		SubShader
		{
			...
			Pass
			{
				...
				fixed4 frag(v2f i) : SV_Target
				{
					...
					fixed4 col = (_Color * _Color.a + glowColor * glow + hexes) * _Opacity;
			...
			Pass
			{
					...
					ZTest Less
					SetTexture[_InWorldTexture] {combine texture}
